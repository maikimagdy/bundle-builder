...
5. Variant name displayed next to product title in review
...
6. Internal 2-column split in review panel (768–885px only)
...
7. Pricing math is calculated dynamically
...
8. Monthly financing estimate uses subtotal ÷ 12
